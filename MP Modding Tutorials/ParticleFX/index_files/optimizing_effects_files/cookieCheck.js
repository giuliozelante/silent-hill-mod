  ...
  var detectCookie = allcookies.indexOf("rockstar_max_check=");
	if (detectCookie != -1) {
		...
		if (over17(age)){
			...
			window.location = "http://www.rockstargames.com/maxpayne/noentry.html";
		}
	}
	else { 
		window.location = "http://www.rockstargames.com/maxpayne/index.html"; 
	}
}
...
function setCookie() {    
 //if the date is valid, create a cookie
	my_setCookie("rockstar_max_visit", "0" , expireDate, ".rockstargames.com", "/");
} 
